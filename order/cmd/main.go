...
import (
	...
	orderAPI "github.com/korchizhinskiy/rocket-factory/order/internal/api/order/v1"
	orderRepository "github.com/korchizhinskiy/rocket-factory/order/internal/repository/order"
	orderService "github.com/korchizhinskiy/rocket-factory/order/internal/service/order"
...
func main() {
	...
	api := orderAPI.NewAPI(invClient, payClient, service)
